...
public class PreContentImpl implements Serializable, Equals, HashCode, PreContent
{
    ...
    public PreContentImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PreContentImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PreContentImpl that = ((PreContentImpl) object);
        {
