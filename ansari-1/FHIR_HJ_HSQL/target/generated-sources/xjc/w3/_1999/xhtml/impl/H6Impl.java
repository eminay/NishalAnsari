...
public class H6Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H6
{
    ...
    public H6Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H6Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H6Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H6Impl that = ((H6Impl) object);
        {
            String lhsLanguage;
