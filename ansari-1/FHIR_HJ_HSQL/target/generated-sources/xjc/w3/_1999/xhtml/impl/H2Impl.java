...
public class H2Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H2
{
    ...
    public H2Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H2Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H2Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H2Impl that = ((H2Impl) object);
        {
            String lhsLanguage;
