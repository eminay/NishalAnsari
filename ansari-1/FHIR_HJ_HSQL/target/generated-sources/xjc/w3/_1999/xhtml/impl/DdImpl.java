...
public class DdImpl
    extends FlowImpl
    implements Serializable, Equals, HashCode, Dd
{
    ...
    public DdImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public DdImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DdImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DdImpl that = ((DdImpl) object);
        {
            String lhsLanguage;
