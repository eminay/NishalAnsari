...
public class UlImpl implements Serializable, Equals, HashCode, Ul
{
    ...
    public UlImpl withLis(List<Li> lis) {
        setLis(lis);
        return this;
    }
    ...
    public UlImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UlImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UlImpl that = ((UlImpl) object);
        {
            List<Li> lhsLis;
            lhsLis = (((this.lis!= null)&&(!this.lis.isEmpty()))?this.getLis():null);
            List<Li> rhsLis;
            rhsLis = (((that.lis!= null)&&(!that.lis.isEmpty()))?that.getLis():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lis", lhsLis), LocatorUtils.property(thatLocator, "lis", rhsLis), lhsLis, rhsLis)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lis", theLis), currentHashCode, theLis);
        }
        {
            String theLanguage;
