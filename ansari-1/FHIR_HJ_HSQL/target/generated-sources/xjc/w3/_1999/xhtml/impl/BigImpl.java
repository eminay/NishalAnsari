...
public class BigImpl
    extends InlineImpl
    implements Serializable, Equals, HashCode, Big
{
    ...
    public BigImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public BigImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BigImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final BigImpl that = ((BigImpl) object);
        {
            String lhsLanguage;
