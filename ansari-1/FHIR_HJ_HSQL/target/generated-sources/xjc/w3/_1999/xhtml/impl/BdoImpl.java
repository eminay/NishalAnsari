...
public class BdoImpl
    extends InlineImpl
    implements Serializable, Equals, HashCode, Bdo
{
    ...
    public BdoImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public BdoImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BdoImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final BdoImpl that = ((BdoImpl) object);
        {
            String lhsLanguage;
