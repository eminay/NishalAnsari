...
public class LiImpl
    extends FlowImpl
    implements Serializable, Equals, HashCode, Li
{
    ...
    public LiImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public LiImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LiImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final LiImpl that = ((LiImpl) object);
        {
            String lhsLanguage;
