...
public class H1Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H1
{
    ...
    public H1Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H1Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H1Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H1Impl that = ((H1Impl) object);
        {
            String lhsLanguage;
