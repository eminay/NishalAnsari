...
public class InlineImpl implements Serializable, Equals, HashCode, Inline
{
    ...
    public InlineImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InlineImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InlineImpl that = ((InlineImpl) object);
        {
