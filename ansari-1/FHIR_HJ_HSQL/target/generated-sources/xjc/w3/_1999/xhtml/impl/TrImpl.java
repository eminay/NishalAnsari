...
public class TrImpl
    implements Serializable, Equals, HashCode, Tr
{
    ...
    public TrImpl withThsAndTds(List<Flow> thsAndTds) {
    ...
    public TrImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TrImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TrImpl that = ((TrImpl) object);
        {
