...
public class H5Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H5
{
    ...
    public H5Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H5Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H5Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H5Impl that = ((H5Impl) object);
        {
            String lhsLanguage;
