...
public class HrImpl implements Serializable, Equals, HashCode, Hr
{
    ...
    public HrImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof HrImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final HrImpl that = ((HrImpl) object);
        {
            String lhsLanguage;
