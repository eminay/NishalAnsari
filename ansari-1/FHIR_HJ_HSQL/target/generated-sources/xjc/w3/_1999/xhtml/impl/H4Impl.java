...
public class H4Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H4
{
    ...
    public H4Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H4Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H4Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H4Impl that = ((H4Impl) object);
        {
            String lhsLanguage;
