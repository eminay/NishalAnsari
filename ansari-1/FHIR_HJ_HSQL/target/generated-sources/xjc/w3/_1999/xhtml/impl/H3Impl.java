...
public class H3Impl
    extends InlineImpl
    implements Serializable, Equals, HashCode, H3
{
    ...
    public H3Impl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public H3Impl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof H3Impl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final H3Impl that = ((H3Impl) object);
        {
            String lhsLanguage;
