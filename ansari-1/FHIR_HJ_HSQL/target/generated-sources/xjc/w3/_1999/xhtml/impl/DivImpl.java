...
public class DivImpl
    extends FlowImpl
    implements Serializable, Equals, HashCode, Div
{
    ...
    public DivImpl withClazzs(List<String> clazzs) {
        setClazzs(clazzs);
        return this;
    }
    ...
    @Override
    public DivImpl withContent(List<Object> content) {
        setContent(content);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DivImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DivImpl that = ((DivImpl) object);
        {
            String lhsLanguage;
