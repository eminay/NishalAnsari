...
public class ProfileQueryImpl
    ...
    implements Serializable, ProfileQuery, Equals, HashCode
{
    ...
    public ProfileQueryImpl withName(org.hl7.fhir.model.String value) {
        setName(value);
        return this;
    }

    public ProfileQueryImpl withDocumentation(org.hl7.fhir.model.String value) {
        setDocumentation(value);
        return this;
    }

    public ProfileQueryImpl withParameters(ProfileSearchParam... values) {
        if (values!= null) {
    ...
    public ProfileQueryImpl withParameters(Collection<ProfileSearchParam> values) {
        if (values!= null) {
    ...
    public ProfileQueryImpl withParameters(List<ProfileSearchParam> parameters) {
        setParameters(parameters);
        return this;
    }

    @Override
    public ProfileQueryImpl withModifierExtensions(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public ProfileQueryImpl withModifierExtensions(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ProfileQueryImpl withModifierExtensions(List<Extension> modifierExtensions) {
        setModifierExtensions(modifierExtensions);
        return this;
    }

    @Override
    public ProfileQueryImpl withExtensions(Extension... values) {
        if (values!= null) {
            for (Extension value: values) {
    ...
    @Override
    public ProfileQueryImpl withExtensions(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ProfileQueryImpl withExtensions(List<Extension> extensions) {
        setExtensions(extensions);
        return this;
    }

    @Override
    public ProfileQueryImpl withId(java.lang.String value) {
        setId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProfileQueryImpl)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ProfileQueryImpl that = ((ProfileQueryImpl) object);
        {
